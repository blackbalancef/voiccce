...
Never commit real API keys. Agent Chime resolves the OpenAI key in this order:
...
Agent hooks are processed locally. The SQLite database lives under `~/.agent-chime` by default.
